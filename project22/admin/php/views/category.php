...
<div class="jq_contents disp-none" id="category_table">
	<div class="container-fluid ">
		<div class="row br-bt-blu">
			<div class="col-sm-3">
				<h3 class="mg-0">&nbsp;&nbsp;&nbsp;<big><i class="fa fa-list-alt"></i></big> Category</h3>
			</div>
			<div class="col-sm-6">
		...
		<div class="container-fluid" id="alluser">
			<?php
				...
				while($row=mysqli_fetch_array($res)){
					...
					<td><input type='text' value='{$row['cat_nm']}' readonly  class='text-center txt-wh form-control name bd-tp-bd-0'></center></td>
					...
					<center><button class='btn btn-link save_account_btn txt-wh disp-none' save_id='$userid'><i class='fa fa-save txt-wh'></i> Save</button></center>
						...
						<select class='form-control text-primary scope'>");
							...
							while($row=mysqli_fetch_array($query)){
								echo("<option value='{$row['scope_id']}'>{$row['scope_nm']}</option>");
							}
